    ...
    <div className="Container">
      ...
      <div  className="Hand">
        <div>
          ...
          <img className="img-card" src={hand[7].cardImage} alt="" />
          <img className="img-card" src={hand[8].cardImage} alt="" />
          <img className="img-card" src={hand[9].cardImage} alt="" />
          <img className="img-card" src={hand[10].cardImage} alt="" /> 
          <img className="img-card" src={hand[11].cardImage} alt="" />
          <img className="img-card" src={hand[12].cardImage} alt="" /> 
          <img className="img-card" src={hand[13].cardImage} alt="" />    
        </div>
      </div>
    </div>
  );
